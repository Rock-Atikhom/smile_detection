...
| Current iPhone Safari  | Pending — no Ticket 04 face-guidance run | Pending — no physical-device test performed          | Pending — no physical-device test performed | Pending     |
