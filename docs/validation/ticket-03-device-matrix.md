...
| Current Android Chrome       | Pending — expected `6c23e451b7a9b523`; manual acceptance required | Pending — expected `float16/1`; manual acceptance required | Pending — manual acceptance required | Pending — manual acceptance required                                                                  | Pending — manual acceptance required                   | Pending — manual acceptance required                         |
...
| MacBook Chrome               | Pending — expected `6c23e451b7a9b523`; manual acceptance required | Pending — expected `float16/1`; manual acceptance required | Pending — manual acceptance required | Pending — manual acceptance required                                                                  | Pending — manual acceptance required                   | Pending — manual acceptance required                         |
