...
| ---------------------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ------------------------------------ | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------------------- |
| Current iPhone Safari        | Pending — not observed; no iPhone available (external device unavailable)                    | Pending — not observed; external device unavailable                                           | Pending — no iPhone device available | Pending — device unavailable                                                                          | Pending — device unavailable                           | Pending — not executed; external device unavailable                 |
