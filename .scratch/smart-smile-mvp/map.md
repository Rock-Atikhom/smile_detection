...
- [Decide the macOS hardware support boundary](issues/12-decide-macos-hardware-support-boundary.md) — limits MVP macOS support and validation to macOS 13+ on Apple Silicon, the combined floor of the selected runtime wheels, with Intel compatibility deferred.
